/***********************************************************************
 ...
 Title        : PROFILER
 Description  : Точность отсчета времени 1uS (1E-6)
                ...
                требует коррекции констант при Fcpu != 72000000
...
char event_count = 0; // счетчик событий. ограничен MAX_PROFILING_EVENT_COUNT. Последующие события игнорируются.
...
/**
 * @brief Заканчиваем отсчёт, выводим в отладочную консоль таблицу стадий и их длительности (время с момента profiling_start(...) и разница между событиями)
 */
